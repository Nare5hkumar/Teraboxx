...
bot_token = os.environ.get('BOT_TOKEN', '7136238408:AAHtT8G5EKv5fIOkbipYLgTP7a1MvlcN6ks')
if len(bot_token) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)
dump_id = os.environ.get('DUMP_CHAT_ID', '-1002149484754')
if len(dump_id) == 0:
...
fsub_id = os.environ.get('FSUB_ID', '-1002381186679')
if len(fsub_id) == 0:
